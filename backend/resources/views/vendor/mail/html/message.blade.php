    ...
    <x-slot:footer>
        <x-mail::footer>
            ...
            @else
                ...
                © {{ date('Y') }} {{ config('app.name') }} | Powered by <a title="Powered by KMTeam LLC" href="https://kmteam.tech"><img src="https://cdn.kmteam.tech/Images/KMTeam-n.png" alt="KMTeam LLC logo" style="height: 20px; vertical-align: middle;"> KMTeam LLC</a>
            @endif
        </x-mail::footer>
    </x-slot:footer>
</x-mail::layout>
